...
#   MODEL=/mnt/nvme0/models/dsv4-flash-UD-Q4_K_XL/...gguf \
#   DRAFT=/mnt/nvme0/models/drafter/DSV4-Flash-DSpark-draft-bf16.gguf \
...
BIN=${BIN:-/mnt/nvme0/wt-ds4-ports/build-cuda/bin/llama-server}
...
date | tee "$OUT"
echo "binary: $BIN ($(git -C /mnt/nvme0/wt-ds4-ports rev-parse --short HEAD 2>/dev/null || echo unknown))" | tee -a "$OUT"
run_arm "" "A-baseline"
