...
for f in ${M}/Ornith-1.0-9B-1M-GGUF/ornith-1.0-9b-1M-*.gguf ${M}/Ornith-1.0-9B-1M-GGUF/mmproj-ornith-9b-f16.gguf; do
...
for f in ${M}/Ornith-1.0-35B-1M-GGUF/ornith-1.0-35b-1M-*.gguf ${M}/Ornith-1.0-35B-1M-GGUF/mmproj-ornith-35b-f16.gguf; do
...
for f in ${M}/Ornith-1.0-397B-1M-GGUF/ornith-1.0-397b-1M-*.gguf; do
