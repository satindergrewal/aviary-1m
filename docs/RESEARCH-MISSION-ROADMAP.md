...
(the owner, verbatim): "make big models run in expected state on my resources with as much big
...
the owner's word to flip a live serve.
...
## PHASE-2 SPEED (park until fit solved, per the owner)
