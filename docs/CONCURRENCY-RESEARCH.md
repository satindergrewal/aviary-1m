...
Opened 2026-07-28 on the owner's brief. The driving case: running the solar prompt
...
| P2 | Metal build + run | the owner wants Apple Silicon covered too | approved, not started |
...
| P9 | Security review | the owner asked explicitly: attack vectors, loose ends | not started |
...
already have a tree at `<BOX>/llama.cpp-tq`.
