...
**the owner's bar, verbatim:** *"I load ANY model, it works as I expect it to work."*
...
**the owner's own models sit squarely in the refused column:** Ornith (`qwen35`/`qwen35moe`),
...
That is the difference between a supported-list and the owner's bar.
