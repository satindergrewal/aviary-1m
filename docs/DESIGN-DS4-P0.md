...
**Status: FOR SATINDER'S READ. No code until he has read this (standing order).**
Author: Fable-DS4 | Date: 2026-08-03 | Grounding: every claim below is against read code in
`/mnt/nvme0/wt-ds4-ports` @ `70ef59be1` (= current fleet) or `/tmp/ds4` @ 82d2a6f, with
...
### 2.5 Open questions for Satinder
...
### 3.5 Open question for Satinder
...
## 7. Open questions for Satinder (the complete list)
