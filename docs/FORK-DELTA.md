...
fleet with Satinder's explicit approval** (cherry-pick of the dsv4-kvpaged `3376ebbc8` content;
...
- Nothing lands on `fleet` without Satinder's explicit per-push approval (standing).
