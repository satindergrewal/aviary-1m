...
Author: Fable-DS4 | Date: 2026-08-03 | the owner's ask: "which kernels we made which gave us
...
- Phase A gating: item 2's arch-mapping read is paper/read-only and fits Phase A; any CODE
  for it queues behind the owner's read of the design doc and the P0 sequence.
