...
>
> This file pins `-ctk q4_0 -ctv q4_0`, and that is what Satinder actually used for
...
```bash
cd /mnt/nvme0/llama.cpp-fleet
./build/bin/llama-server \
  -m /mnt/nvme0/bigmodels/glm52-ours/GLM-5.2-ours-IQ1_S-prot.gguf \
  -ngl 99 \
  --tensor-split 49,51 \
  -c 65536 \
  -b 1024 -ub 256 \
...
from `/mnt/nvme0/llama.cpp-fleet`.
